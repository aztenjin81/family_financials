...
function HeroNetWorth({ hidden, range, setRange }) {
...
function TransactionsCard({ hidden }) {
  return (
    <div className="card">
      <div className="card-header">
        <div>
...
function InvestmentsCard({ hidden }) {
...
function KidsCard({ hidden, chores, toggleChore }) {
  return (
...
Object.assign(window, {
  HeroNetWorth, HeroSpend, HeroCashflow,
  AccountsRail, SpendingCard, ForecastCard,
  GoalsCard, TransactionsCard, BillsCard,
  InvestmentsCard, DebtCard, KidsCard
});
